...
<html lang="en">
  ...
  <head>
   ...
   $(function(){
	...
	<script src="${pageContext.request.contextPath }/site/js/datas/sd115Data.js"></script>
	<script src="${pageContext.request.contextPath }/site/js/bets/sd115.js"></script>
						...
						<article class="rich-text-element main-column">
							<article class="widget registration-form">
								...
								<div class="lottery">
									<div class="left_box">
										<div class="lo_title">
											<span class="lo_name">山东11选5</span> <span>第 <font
