...
<html lang="en">
  ...
  <head>
   ...
   <script type="text/javascript">
	...
	<script src="${pageContext.request.contextPath }/site/js/datas/pl3Data.js"></script>
	<script src="${pageContext.request.contextPath }/site/js/bets/pl3.js"></script>
  </head>
					...
					<div class="stack gutter-col size4of5">
						<article class="rich-text-element main-column">
							<article class="widget registration-form">
								...
								<div class="lottery">
									<div class="left_box">
										<div class="lo_title">
											<span class="lo_name">排列三</span> <span>第 <font
                        ...
                        <div id="subContent_bet" class="operate">
                            ...
                            <div id="nav-sub">
                                    ...
                                    <li value="sm" id="two2" class="active">
