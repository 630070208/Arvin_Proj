...
<body class="layout-two-column unibet custom-background">
	<div id="container">
		2<jsp:include page="../common/WerHeader.jsp"></jsp:include>
		<div id="content">
			<div id="top">
				<div class="inner"></div>
			</div>
							...
							<article class="widget registration-form">
								<form action="" method="post" id="createUserForm"
									...
									<div style="margin-left:12px;margin-right:12px;margin-top:12px;">
										<label>今日流水：${theDay}</label>
										<label>本月流水流水：${monMoney}</label>
										<label>历史流水：${hisMoney}</label><br/>
										<font color="red">
											注:
											  1:本月流水指月初到月末的流水统计,包含今日流水；
									              	        历史流水指本月初之前的流水;
									      	 2:流水算法：充值+派奖+返佣+分红+购彩+提款-退款
										</font>								           
									</div>
								</form>
							</article>
