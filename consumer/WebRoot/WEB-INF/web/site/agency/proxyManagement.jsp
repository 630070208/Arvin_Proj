...
function sendOrderById(id){
	$("#sendId").val(id);
	document.sendFrom.action="/uc/agencyOrderList";
	document.sendFrom.submit();
}
...
<form action="${pageContext.request.contextPath }/uc/memberManagementPage" id="form" method="post" name="search">
	...
	<table id="userlistDL" class="bingo-game-chooser-table table-decoration-7 color-theme-4">
		<thead>
			<tr>
				...
				<th><div class="title"><span>会员等级</span></div></th>
	...
	<c:forEach var="item" items="${page.result}">
		<tr>
			...
			<td>	
				<a href="javascript:sendOrderById('${item.member.id}')">购彩记录</a>&nbsp;&nbsp;
				<a href="javascript:sendId('${ item.member.id}')">修改</a>&nbsp;&nbsp;
