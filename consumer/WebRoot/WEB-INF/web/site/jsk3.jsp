...
<script
	src="${pageContext.request.contextPath }/site/js/datas/jsk3Data.js"></script>
<script src="${pageContext.request.contextPath }/site/js/bets/jsk3.js"></script>
						...
						<article class="rich-text-element main-column">
							<article class="widget registration-form">
								...
								<div class="lottery">
									<div class="left_box">
										<div class="lo_title">
											<span class="lo_name">江苏快3</span> <span>第 <font
										...
										<div class="num_open">
											<ul class="li_left">
												<li><span class="each"><span id="last_code_num0">4</span>
												</span></li>
												<li><span class="each"><span id="last_code_num1">3</span>
												</span></li>
												<li><span class="each"><span id="last_code_num2">9</span>
												</span></li>
												<li><span class="each"><span id="last_code_num3">0</span>
												</span></li>
												<li><span class="each"><span id="last_code_num4">1</span>
												</span></li>
											</ul>
										</div>
									</div>
								...
								<div id="subContent_bet" class="operate">
									...
									<div id="nav-sub">
										<nav>
											<ul id="lotteryTopType" class="color-theme-1">
												<li value="eth" id="two2" class="active"><span
													class="m">二同号</span></li>
												<li value="sth" id="two3"><span class="m">三同号</span></li>
												<li value="sbt" id="two4"><span class="m">三不同号</span></li>
												<li value="slh" id="two4"><span class="m">三连号通选</span>
												</li>
												<li value="ebt" id="two4"><span class="m">二不同号</span></li>
												<li value="hz" id="two4"><span class="m">和值</span></li>
											</ul>
										</nav>
									</div>
									<div class="Contentbox" id="lotteryDetail">
										<div class="minitype" id="lotterySubType">
											<div class="item">
												<h5>后三直选</h5>
												<label class="li_hover"> <input
													style="display:none;" type="radio" id="smalllabel_0_0"
													name="smalllabel" value="0-0" checked="checked"><span
													class="subType">复式</span> </label> <label class="li"> <input
													style="display:none;" type="radio" id="smalllabel_0_1"
													name="smalllabel" value="0-1" checked="checked"><span
													class="subType">单式</span> </label> <label class="li"> <input
													style="display:none;" type="radio" id="smalllabel_0_2"
													name="smalllabel" value="0-2" checked="checked"><span>直选和值</span>
												</label>
											</div>
										</div>
