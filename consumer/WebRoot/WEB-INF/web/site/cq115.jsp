...
<html lang="en">
  ...
  <head>
	...
	<script src="${pageContext.request.contextPath }/site/js/datas/cq115Data.js"></script>
	<script src="${pageContext.request.contextPath }/site/js/bets/cq115.js"></script>
  </head>
					...
					<div class="stack gutter-col size4of5">
						<article class="rich-text-element main-column">
							<article class="widget registration-form">
								...
								<div class="lottery">
									<div class="left_box">
										<div class="lo_title">
											<span class="lo_name">重庆11选5</span> <span>第 <font
                        ...
                        <div id="subContent_bet" class="operate">
                            ...
                            <div id="nav-sub">
                                    ...
                                    <li value="qw" id="two4">
                                        <span class="m">趣味型</span>
                                    </li>
                                    <li value="rxf" id="two4" class="active">
                                        <span class="m">任选复式</span>
                                    </li>
                                </ul>
                                </nav>
                            </div>
