...
<html lang="en">
  ...
  <head>
   ...
   <script type="text/javascript">
	...
	<script src="${pageContext.request.contextPath }/site/js/datas/XjsscData.js"></script>
	<script src="${pageContext.request.contextPath }/site/js/bets/xjssc.js"></script>
  </head>
					...
					<div class="stack gutter-col size4of5">
						<article class="rich-text-element main-column">
							<article class="widget registration-form">
								...
								<div class="lottery">
									<div class="left_box">
										<div class="lo_title">
											<span class="lo_name">新疆时时彩</span> <span>第 <font
                        ...
                        <div id="subContent_bet" class="operate">
                            ...
                            <div id="nav-sub">
                                    ...
                                    <li value="sx" id="two2">
                                        <span class="m">四星</span>
                                    </li>
                                    <li value="hs" id="two3" class="active">
                                        <span class="m">后三码</span>
                                    </li>
                                    <li value="qs" id="two4">
                                        <span class="m">前三码</span>
                                    </li>
                                    <li value="qe" id="two4">
                                        <span class="m">前二码</span>
                                    </li>
                                    <li value="he" id="two4">
                                        <span class="m">后二码</span>
                                    </li>
                                    ...
                                    <li value="dxds" id="two4">
                                        <span class="m">大小单双</span>
                                    </li>
                                </ul>
                                </nav>
                            </div>
