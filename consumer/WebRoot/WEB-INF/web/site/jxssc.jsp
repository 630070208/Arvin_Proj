...
<script src="${pageContext.request.contextPath }/site/js/datas/JxsscData.js"></script>
<script src="${pageContext.request.contextPath }/site/js/bets/jxssc.js"></script>
</head>
						...
						<article class="rich-text-element main-column">
							<article class="widget registration-form">
								...
								<div class="lottery">
									<div class="left_box">
										<div class="lo_title">
											<span class="lo_name">江西时时彩</span> <span>第 <font
									...
									<div id="nav-sub">
										<nav>
											<ul id="lotteryTopType" class="color-theme-1">
												<li value="sx" id="two2"><span class="m">四星</span></li>
												<li value="hs" id="two3" class="active"><span class="m">后三码</span>
												</li>
												<li value="qs" id="two4"><span class="m">前三码</span></li>
												<li value="qe" id="two4"><span class="m">前二码</span></li>
												<li value="he" id="two4"><span class="m">后二码</span></li>
												<li value="dwd" id="two4"><span class="m">定位胆</span></li>
												<!--  <li value="bdw" id="two4">
                                        <span class="m">不定位</span>
                                    </li> -->
