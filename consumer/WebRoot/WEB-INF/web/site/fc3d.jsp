...
<html lang="en">
  ...
  <script type="text/javascript">
	...
	<script src="${pageContext.request.contextPath }/site/js/datas/fc3dData.js"></script>
	<script src="${pageContext.request.contextPath }/site/js/bets/fc3d.js"></script>
  </head>
					...
					<div class="stack gutter-col size4of5">
						<article class="rich-text-element main-column">
							<article class="widget registration-form">
								...
								<div class="lottery">
									<div class="left_box">
										<div class="lo_title">
											<span class="lo_name">福彩3D</span> <span>第 <font
                                ...
                                <div class="num_open">
                                    <ul>
                                        <li>
                                            <span class="each"><span id="last_code_num0">4</span></span>
                                        </li>
                                        <li>
                                            <span class="each"><span id="last_code_num1">3</span></span>
                                        </li>
                                        <li>
                                            <span class="each"><span id="last_code_num2">9</span></span>
                                        </li>
                                        <li>
                                            <span class="each"><span id="last_code_num3">0</span></span>
                                        </li>
                                        <li>
                                            <span class="each"><span id="last_code_num4">1</span></span>
                                        </li>
                                    </ul>
                                </div>
                               </div>
									<div class="current_times">
										<div class="d_box">
											<input type="hidden" name="issueCode" value="${issue.issueCode }" />
                        ...
                        <div id="subContent_bet" class="operate">
                            ...
                            <div id="nav-sub">
                                    ...
                                    <li value="sm" id="two2" class="hover">
                                        <span class="m">三码</span>
                                    </li>
                                    <li value="em" id="two3">
                                        <span class="m">二码</span>
                                    </li>
                                    <li value="dwd" id="two4">
                                        <span class="m">定位胆</span>
                                    </li>
                                    <li value="qsw" id="two4">
                                        <span class="m">不定胆</span>
                                    </li>
                                </ul>
                                </nav>
                            </div>
