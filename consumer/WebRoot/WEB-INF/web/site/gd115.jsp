...
<html lang="en">
  ...
  <head>
   ...
   $(function(){
	...
	<script src="${pageContext.request.contextPath }/site/js/datas/gd115Data.js"></script>
	<script src="${pageContext.request.contextPath }/site/js/bets/gd115.js"></script>
  </head>
						...
						<article class="rich-text-element main-column">
							<article class="widget registration-form">
								...
								<div class="lottery">
									<div class="left_box">
										<div class="lo_title">
											<span class="lo_name">广东11选5</span> <span>第 <font
                                ...
                                <div class="num_open">
                                    <ul>
                                        <li>
                                            <span class="each"><span id="last_code_num0"></span></span>
                                        </li>
                                        <li>
                                            <span class="each"><span id="last_code_num1"></span></span>
                                        </li>
                                        <li>
                                            <span class="each"><span id="last_code_num2"></span></span>
                                        </li>
                                        <li>
                                            <span class="each"><span id="last_code_num3"></span></span>
                                        </li>
                                        <li>
                                            <span class="each"><span id="last_code_num4"></span></span>
                                        </li>
                                    </ul>
                                </div>
                               </div>
