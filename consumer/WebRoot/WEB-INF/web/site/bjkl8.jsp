...
<html lang="en">
  ...
  <head>
	...
	<script src="${pageContext.request.contextPath }/site/js/datas/bjkl8Data.js"></script>
	<script src="${pageContext.request.contextPath }/site/js/bets/bjkl8.js"></script>
  </head>
					...
					<div class="stack gutter-col size4of5">
						<article class="rich-text-element main-column">
							<article class="widget registration-form">
								...
								<div class="lottery">
									<div class="left_box">
										<div class="lo_title">
											<span class="lo_name">北京快乐8</span> <span>第 <font
                                ...
                                <div class="num_open_k8">
			                        <ul>
				                        ...
				                        <li><span class="each"><span id="last_code_num8" class="">42</span></span></li>
				                        <li><span class="each"><span id="last_code_num9" class="">43</span></span></li>
				                    </ul>
				                    <ul>
				                        <li><span class="each"><span id="last_code_num10" class="">44</span></span></li>
				                        <li><span class="each"><span id="last_code_num11" class="">46</span></span></li>
				                        <li><span class="each"><span id="last_code_num12" class="">56</span></span></li>
				                        <li><span class="each"><span id="last_code_num13" class="">59</span></span></li>
				                        <li><span class="each"><span id="last_code_num14" class="">62</span></span></li>
				                        <li><span class="each"><span id="last_code_num15" class="">63</span></span></li>
				                        <li><span class="each"><span id="last_code_num16" class="">65</span></span></li>
				                        <li><span class="each"><span id="last_code_num17" class="">72</span></span></li>
				                        <li><span class="each"><span id="last_code_num18" class="">74</span></span></li>
				                        <li><span class="each"><span id="last_code_num19" class="">77</span></span></li>  
				                    </ul>
			                    </div>
                                </div>
                        ...
                        <div id="subContent_bet" class="operate">
                           ...
                           <div id="nav-sub">
                                    ...
                                    <li value="qw" id="two2" class="active">
                                        <span class="m">趣味</span>
                                    </li>
                                    <li value="rx" id="two3">
                                        <span class="m">任选</span>
                                    </li>
                                </ul>
                                </nav>
                            </div>
