package com.game.servic.business.dubbo.test;
	  ...
	  public byte[] getData(String path) throws KeeperException, InterruptedException {   
	   ...
	   public static void main(String[] args) {
	     try {   
	              ...
	              List<String> list = zkoperator.zooKeeper.getChildren("/dubbo/com.game.servic.business.dubbo.OrderDubboServices/providers/", false);
